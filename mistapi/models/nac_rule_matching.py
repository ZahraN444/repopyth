...
class NacRuleMatching(object):
    ...
    Attributes:
        auth_type (NacRuleMatchingAuthTypeEnum): TODO: type description here.
        nactags (List[str]): TODO: type description here.
        port_types (List[NacRuleMatchingPortTypeEnum]): TODO: type description
            here.
        site_ids (List[uuid|str]): list of site ids to match
        sitegroup_ids (List[uuid|str]): list of sitegroup ids to match
        vendor (List[str]): list of vendors to match
    ...
    def from_dictionary(cls,
        ...
        auth_type = dictionary.get("auth_type") if dictionary.get("auth_type") else APIHelper.SKIP
